    ...
    <main className="min-h-screen bg-[#0f0d08] text-white flex flex-col items-center py-10 px-4">
      ...
      <section className="w-full max-w-5xl bg-[#2b2825] rounded-xl p-6 md:p-8 mb-10 shadow-lg">
        ...
        <div className="space-y-10 text-sm md:text-base text-gray-200 leading-relaxed">
          ...
          {/* Delegate Book Download */}
          <div className="pt-6 mt-6 border-t border-[#3b332d]">
            <h3 className="text-[#e0a82e] font-semibold mb-3">
              Delegate Book
            </h3>
            <div className="bg-[#1f1c19] rounded-lg p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border border-[#3b332d]">
              <div>
                <p className="text-gray-200 text-sm">
                  Download the official delegate book.
                </p>
              </div>
              <a
                href="https://drive.google.com/file/d/19XwjpCQaAi4G4PWgL-lIYiCU0QIKjfZE/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 inline-flex items-center gap-2 bg-[#e0a82e] text-black px-4 py-2 rounded font-semibold text-sm hover:bg-[#f2c14e] transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
