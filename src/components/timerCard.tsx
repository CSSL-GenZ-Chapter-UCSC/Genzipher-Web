...
export default function TimerCard({ value, label }: { value: number; label: string }) {
  ...
  return (
    <div className="text-[0.65rem] md:text-[1.1rem] timer-item flex flex-col items-center justify-start text-[#D7CEBB]">
      <div className="flex gap-1 md:gap-3 w-full max-w-[70px] md:max-w-[170px] lg:max-w-[200px]">
        <div className="flex-1 min-w-[28px] md:min-w-[72px] lg:min-w-[82px]">
      ...
      <div
        className="mt-1 md:mt-2 neue-machina font-extrabold text-[0.65rem] md:text-[1.05rem] lg:text-[1.15rem] px-2 py-1 rounded-md inline-block bg-clip-text text-transparent"
        style={{
          background:
